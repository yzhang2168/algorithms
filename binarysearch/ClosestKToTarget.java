...
public class ClosestKToTarget {	
	/**
	 * closest k elements to target
	 * binary search + 谁小移谁 O(log n + k), return k elements in order of distance to target
	 * binary search + binary search array of distance from target O(log n + log k), return {left bound, right bound}
	 * 1 2 3 8 9
	 *     l r    target = 4
	 *     		  k = 4 {3,2,1,8}
	 * */
