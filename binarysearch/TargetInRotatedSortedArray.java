...
/**
 * turning point < m <--> input[m] < input[r]
 * so [m...r] is sorted
 * [5,0,1,2,3,4]
 *  l	m     r
 * 
 * turning point > m <--> input[m] > input[r]
 * so [l...m] is sorted
 * [2,3,4,5,0,1]	target = 2
 *  l   m     r
 * 
 * case 1. input[m] == target, return
 * case 2. input[m] <  input[r]: turning point < m --> [m...r] is sorted
 * 		2.1 if input[m] < target <= input[r], look in the right part
 * 		2.2 else, look in the left
 * case 3. input[m] >  input[r]: turning point > m --> [l...m] is sorted
 * 	    3.1 if input[l] <= target < input[m], look in the left
 * 		3.2 else, look in the right
 * */
